...
export default {
    ...
    PAYMENT_PENDING_WORKER_INTERVAL_MS: +process.env.PAYMENT_PENDING_WORKER_INTERVAL_MS,
    PAYMENT_PENDING_WORKER_MAX_RECORDS: +process.env.PAYMENT_PENDING_WORKER_MAX_RECORDS,
