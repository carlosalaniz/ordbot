...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { InscriptionController } from './common/controllers/inscribe.controller';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { ServerController } from './common/controllers/server.controller';
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.post('/inscriptions/queue',
            upload.single('file'),
            ...(fetchMiddlewares<RequestHandler>(InscriptionController)),
            ...(fetchMiddlewares<RequestHandler>(InscriptionController.prototype.uploadFileInscription)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/server/messages',
            ...(fetchMiddlewares<RequestHandler>(ServerController)),
            ...(fetchMiddlewares<RequestHandler>(ServerController.prototype.getMessages)),

            function ServerController_getMessages(request: any, response: any, next: any) {
            const args = {
            };
